  ...
  const presets: PresetConfig[] = [
    // Frontend Presets
    {
      ...
      options: {
        ...
        instructions:
          "Focus on advanced React hooks patterns and best practices",
      },
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Generate targeted questions based on {position.title} requirements
        </CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="bg-muted mt-4 p-3 rounded-lg">
          <p className="text-muted-foreground text-sm">
            💡 <strong>Tip:</strong> These presets use optimized parameters for
            each question type. You can customize them further in the advanced
            generation dialog.
          </p>
        </div>
      </CardContent>
