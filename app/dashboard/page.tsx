    ...
    <div className="grid gap-4 md:grid-cols-3">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Posizioni attualmente aperte</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Candidati totali nel sistema</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-sm font-medium">Colloqui Completati</CardTitle>
          <BarChart3 className="h-4 w-4 text-muted-foreground" />
        </CardHeader>
        <CardContent>
          <div className="text-2xl font-bold">{interviewsCount || 0}</div>
          <p className="text-xs text-muted-foreground">Colloqui completati con successo</p>
        </CardContent>
      </Card>
    </div>
  )
        ...
        {positions && positions.length > 0 ? (
            ...
            {positions.map((position) => (
              <div key={position.id} className="flex items-center justify-between rounded-lg border p-3">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">{position.experience_level}</div>
                </div>
          ...
          <div className="flex h-[140px] flex-col items-center justify-center rounded-lg border border-dashed">
            <div className="text-center">
              <p className="text-sm text-muted-foreground">Nessuna posizione creata</p>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="col-span-1">
          <CardHeader>
            ...
            <CardDescription>Le ultime attività sulla piattaforma</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex h-[140px] flex-col items-center justify-center rounded-lg border border-dashed">
              <div className="text-center">
